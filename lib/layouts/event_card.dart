  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
              ...
              ListTile(
                ...
                subtitle: _isEditing
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      onPressed: _pickDate,
                      icon: const Icon(Icons.calendar_today, color: Color(0xFFDB2367)),
                      label: Text(
                        _date.isNotEmpty
                            ? 'Selected Date: $_date'
                            : 'Pick a Date',
                        style: const TextStyle(
                          fontFamily: 'Aclonica',
                          fontSize: 12, // Smaller font size for editing mode
                    ...
                    IconButton(
                      onPressed: () {
                        setState(() {
                          ...
                          // Reset to original values if exiting editing
                          if (!_isEditing) {
                      ...
                      icon: Icon(
                        ...
                        color: _isEditing ? Colors.red : Color(0xFFDB2367),
                      ),
                    ),
                    IconButton(
                ...
                Align(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      // Pass the updated Event to the onUpdate callback
        ...
        const SizedBox(height: 16), // Adds spacing after the card
      ],
    );
  }
}
